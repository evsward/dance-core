 ...
 */
package com.dance.core.orm.hibernate;
...
import com.dance.core.orm.PropertyFilter.MatchType;
 ...
 * @author zzm
 */
public class HibernateDaoExt<T, PK extends Serializable> extends HibernateDaoImpl<T, PK> implements BaseDao<T,PK>{
	/**
	 * 用于Dao层子类的构造函数.
	 ...
	 */
	public HibernateDaoExt(final SessionFactory sessionFactory, final Class<T> entityClass) {
	...
	public Page<T> find(Page<T> page, T entity) throws Exception {
		return findPage(page);
	}

	public Page<T> find(Page<T> page, String ql, Object... values)
			throws Exception {
		return findPage(page,ql,values);
	}
